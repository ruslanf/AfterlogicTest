...
class ApiContactsInfoUids implements ApiContactsInfoUidsInterface {
  @override
  Future<ContactInfoUid> getContactsInfoUIDS(
      String token, String id, List<String> uids) async {
